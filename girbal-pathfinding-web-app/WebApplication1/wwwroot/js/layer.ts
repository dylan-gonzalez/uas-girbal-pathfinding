...
//        this.element.parentElement.addEventListener("mousedown", e => this.onLayerMouseDown(e));
//        this.element.parentElement.addEventListener("mouseup", e => this.onLayerMouseUp(e));
//    }
...
//    private onLayerMouseDown(event: MouseEvent) {

//    }

//    private onLayerMouseUp(event: MouseEvent) {
...
//        img.classList.add(`image-x-${x}-y-${y}`);
